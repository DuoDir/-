  ...
  <el-container class="GroupEdit" v-loading="loading">
    ...
    <el-main> 
      <el-form label-width="100px" class="demo-ruleForm" size="mini" style="padding: 20px 20px;">
        <el-row class="el_row">
          <el-col :span="6">
            <el-form-item label="专营店号:" :required="true">
              <el-input v-model="number" disabled  placeholder=""></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="专营店简称:" :required="true">
              <el-input v-model="form.shortName" maxlength="30" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="专营店全称:" :required="true">
              <el-input v-model="form.organizationName" maxlength="30" placeholder="请输入营业执照名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="店面性质:" :required="true">
              <el-input v-model="form.storenameType" disabled maxlength="30" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row class="el_row">
          <el-col :span="6">
            <el-form-item label="营业城市:" :required="true">
              <el-col :span="8">
          ...
          <el-col :span="6">
            <el-form-item label="营业地址:" :required="true">
              <div class="all">
          ...
          <el-col :span="6">
            <el-form-item label="店内电话:" :required="true">
              <el-input v-model="form.storeMobile"  maxlength="12" @input="handlemoney($event, 'storeMobile')" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="店内邮箱:" :required="true">
        ...
        <el-row class="el_row">
          <el-col :span="6">
            <el-form-item label="营业时间:" :required="true">
              <el-col :span="12">
                <el-time-picker v-model="form.startTime" format = 'HH:mm' value-format = 'HH:mm' placeholder="开始时间"></el-time-picker>
              </el-col>
              <el-col :span="12">
                <el-time-picker v-model="form.endTime" format = 'HH:mm' value-format = 'HH:mm' placeholder="结束时间"></el-time-picker>
              </el-col>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="店总经理:" :required="true">
              <el-input v-model="form.principalName" maxlength="30" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="联系电话:" :required="true">
              <el-input v-model="form.phoneNumber" maxlength="11" @input="handlemoney($event, 'phoneNumber')" placeholder="请输入店总经理手机号"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row class="el_row">
          <el-col :span="6">
            <el-form-item label="银行账户:" :required="true">
              <el-input v-model="form.bankAccount" maxlength="30" @input="handlemoney($event, 'bankAccount')" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="6">
           ...
           <el-col :span="6">
            <el-form-item label="联行号:" :required="true">
              <el-input v-model="form.bankRelationNo" maxlength="30" @input="handlemoney($event, 'bankRelationNo')" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row class="el_row">
      ...
      submit() {
        ...
        .then(res=>{
          ...
          if(res.code == 0){
            ...
            this.$store.dispatch("delVisitedViews", StoreEdit).then(() => {
              this.$router.push({
                path: "/StoreList",
              });
            });
